...
public class InterstitialAdForVideoAppActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		button.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				if (ad.isAdReady()) {
					ad.showAdInParentForVideoApp(InterstitialAdForVideoAppActivity.this, relativeLayout);
				} else {
					loadAd();
				}
			}
	...
	private void createQianTiePianAd() {
		ad = new InterstitialAd(this, AdSize.InterstitialForVideoBeforePlay, "");
	...
	private void createZanTingYeAd() {
		ad = new InterstitialAd(this, AdSize.InterstitialForVideoPausePlay, "");
		ad.setListener(new InterstitialAdListener() {
	...
	private void loadAd() {
		...
		ad.loadAdForVideoApp(width, height);
	}
